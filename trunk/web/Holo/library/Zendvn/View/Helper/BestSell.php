<?php
class Zendvn_View_Helper_BestSell extends Zend_View_Helper_Abstract{
	public function bestSell(){
		
		$html='<table width="184" border="0" cellpadding="0" cellspacing="0" id="table">
  <tr>
    <td><img src="'.$this->view->imgUrl.'/sanphambanchaynhat.gif" width="184" height="33" /></td>
  </tr>
  <tr>
    <td id="infotable">';
    
	foreach ($this->getBestSell() as  $value) {
